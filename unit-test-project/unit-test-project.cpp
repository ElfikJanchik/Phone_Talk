...
namespace unittestproject
{
	...
	public:
		TEST_METHOD(TestMethod1)
		{
			...
			Assert::AreEqual(0.000490057, process(subscriptions, 3));
		...
		TEST_METHOD(TestMethod2)
		{
			...
			Assert::AreEqual(0.000380338, process(subscriptions, 3));
			delete_subscription(subscriptions, 3);
		...
		TEST_METHOD(TestMethod3)
		{
			...
			Assert::AreEqual(0.000994843, process(subscriptions, 3));
			delete_subscription(subscriptions, 3);
